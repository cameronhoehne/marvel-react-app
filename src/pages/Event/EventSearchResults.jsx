...
function EventSearchResults() {
    ...
    try {
        ...
        if (data.data.results.length <= 0) {
            navigate("/noresults", { state: {location: "events"}})
        }
    }
...
const captureId = (event, id) => {
    ...
    window.scrollTo(0, 0)
    navigate("/category/events/searched/" + id)
}
...
const Creators = () => {
  ...
  return (
    ...
    <Container className='cover-image-events'
        initial={{x: "100%"}} 
        animate={{x: "0%"}}
        ...
        >Use the search bar below to find out more about some of the most pivotal events in Marvel history</m.p>
        <EventSearch />
